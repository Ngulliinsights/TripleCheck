...
> **Rule of thumb:** Issues that can *appear on screen during a demo* are critical. Issues that make the codebase look unpolished to a reviewer are warnings. Everything else is post-demo housekeeping.
