...
import cors from '..\scripts\cleanup-redundancies';
...
import { b2bRouter } from './b2b\b2b.controller';
import { communityRouter } from './community\community.controller';
import { fraudAlertsRouter } from './fraud-detection\alerts.controller';
import { healthRouter } from './monitoring\health.controller';
import { monitoringRouter } from './monitoring\monitoring.controller';
import { notificationsRouter } from './communication\notifications.controller';
import { propertyEnhancementsRouter } from './property\enhancements.controller';
import { trustIntegrationRouter } from './trust\integration.controller';
import { userDashboardRouter } from './user\dashboard.controller';
