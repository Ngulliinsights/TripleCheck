...
async function main(): Promise<void> {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    ...
    console.log('=====================================');
    console.log('');
    console.log('Usage: tsx database/utils/generators/unified-generator.ts [users] [properties] [reviews] [options]');
    console.log('');
    ...
    console.log('  tsx database/utils/generators/unified-generator.ts');
    console.log('  tsx database/utils/generators/unified-generator.ts 2000 1000 5000');
    console.log('  tsx database/utils/generators/unified-generator.ts 500 250 1000 --python');
    console.log('  tsx database/utils/generators/unified-generator.ts 1000 500 2000 --fraud-rate=0.05');
    return;
  }
  ...
  try {
    ...
    if (report.errors.length === 0) {
      ...
      console.log('\nNext steps:');
      console.log('   1. Load data: tsx database/scripts/data-pipeline.ts');
      console.log('   2. Verify database: tsx database/scripts/validate.ts');
