...
const HOOK_MIGRATIONS = {
  ...
  'useForm': {
    ...
    newImport: "import { useFormValidation } from '..\src\shared\hooks\useFormValidation';",
    complexity: 'medium',
    autoFixable: false,
...
const form = useFormValidation({
  ...
  'useProperties': {
    ...
    newImport: "import { useSafePropertiesQuery } from '..\src\shared\hooks\useSafeQuery';",
    complexity: 'low',
    autoFixable: true,
...
const { data, isLoading } = useSafePropertiesQuery(params);`
  ...
  'useProperty': {
    ...
    newImport: "import { useSafePropertyQuery } from '..\src\shared\hooks\useSafeQuery';",
    complexity: 'low',
    autoFixable: true,
    description: 'Direct replacement with enhanced error handling',
    example: `
...
const { data } = useSafePropertyQuery(id);`
  ...
  'useOwnerProperties': {
    ...
    newImport: "import { useSafeOwnerPropertiesQuery } from '..\src\shared\hooks\useSafeQuery';",
    complexity: 'low',
    autoFixable: true,
    description: 'Direct replacement with enhanced error handling'
  },
  ...
  'usePropertyActions': {
    ...
    newImport: "import { useSafePropertyActionsQuery } from '..\src\shared\hooks\useSafeQuery';",
    complexity: 'high',
    autoFixable: false,
...
const { data } = useSafePropertyActionsQuery('favorites', propertyId);`
  ...
  'usePropertySearch': {
    ...
    newImport: "import { useSafePropertySearchQuery } from '..\src\shared\hooks\useSafeQuery';",
    complexity: 'medium',
    autoFixable: false,
  ...
  'usePerformanceMonitor': {
    ...
    newImport: "import { useComponentPerformance } from '..\src\shared\hooks\useComponentPerformance';",
    complexity: 'medium',
    autoFixable: false,
  ...
  'usePaginatedQuery': {
    ...
    newImport: "import { usePagination } from '..\src\shared\hooks\usePagination';",
    complexity: 'medium',
    autoFixable: false,
