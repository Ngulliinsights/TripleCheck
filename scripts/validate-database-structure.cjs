...
/**
 * Database Structure Validation Script (CommonJS version)
 * 
...
class DatabaseStructureValidator {
  ...
  printResults() {
    ...
    if (failCount > 0) {
      ...
      console.log('\n🔧 Next Steps:');
      console.log('1. Run migration: node scripts/migrate-database-structure.cjs');
      console.log('2. Test after migration: node scripts/validate-database-structure.cjs');
    } else {
