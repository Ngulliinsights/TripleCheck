      ...
      const importMappings = [
        {
          ...
          new: "import { cacheService } from '../../core/src/cache'"
        },
        {
          old: /import\s*{\s*cacheService\s*as\s*enhancedCache\s*}\s*from\s*["']\.\.\/services\/CacheService["']/g,
          new: "import { cacheService as enhancedCache } from '../../core/src/cache'"
        },
        {
        ...
        },
        {
          ...
          new: "import { PropertyCacheService } from '../../core/src/cache'"
        }
      ];
