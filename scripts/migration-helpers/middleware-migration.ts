    ...
    try {
      ...
      if (content.includes('CommonValidationSchemas')) {
        updatedContent = updatedContent.replace(
          ...
          "import { CommonValidationSchemas } from '..\..\server\middleware\validation.middleware'"
        );
        hasChanges = true;
      }
    ...
    try {
      ...
      if (content.includes('SessionManager.')) {
        updatedContent = updatedContent.replace(
          ...
          "import { SessionManager } from '..\..\server\middleware\auth.middleware'"
        );
        hasChanges = true;
      }
...
} from '..\..\server\land-verification\middleware\validation.middleware';
