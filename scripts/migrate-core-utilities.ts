...
class CoreUtilitiesMigrator {
  ...
  private setupMigrationRules(): void {
    ...
    this.migrationRules.push(
      ...
      },
      {
        ...
        replacement: "import { CacheService, defaultCacheConfig } from '..\server\cache\CacheService'",
      ...
      },
      {
        ...
        replacement: "import { cacheService, CacheKeys } from '..\server\cache\CacheService'",
      ...
      },
      {
        ...
        replacement: "import { cacheService, CacheKeys, CacheOptions } from '..\server\cache\CacheService'",
    ...
    this.migrationRules.push(
      {
        ...
        replacement: "import { requireAuth, AuthenticatedRequest } from '..\server\middleware\auth.middleware'",
      ...
      },
      {
        ...
        replacement: "import { validateRequest } from '..\server\land-verification\middleware\validation.middleware'",
      ...
      },
      {
        ...
        replacement: "import { cacheResponse } from '..\server\middleware\cache.middleware'",
    ...
    this.migrationRules.push(
      {
        ...
        replacement: "import { ValidationError } from '..\server\infrastructure\database\data-generation\scenarios\demo-data-validator'",
        description: "Migrate ValidationError import"
      },
      {
        pattern: /import\s*{\s*AppError\s*}\s*from\s*["']\.\.\/shared\/error-handling["']/g,
        replacement: "import { AppError } from '..\server\tests\api-bug-fixes'",
  ...
  async addCoreImports(): Promise<void> {
    ...
    for (const update of filesToUpdate) {
      ...
      if (needsLogger) {
        imports.push("import { logger } from '..\server\infrastructure\monitoring\logger';");
      }
