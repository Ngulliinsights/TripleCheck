...
export const mockProperties = [
  {
    ...
    price: 15000000,
    images: ['/assets/Residential/cytonn-photography-TVyhDpvL8MY-unsplash.jpg', '/assets/Residential/frames-for-your-heart-2d4lAQAlbDA-unsplash.jpg'],
    imageUrls: ['/assets/Residential/cytonn-photography-TVyhDpvL8MY-unsplash.jpg', '/assets/Residential/frames-for-your-heart-2d4lAQAlbDA-unsplash.jpg'],
    features: {
      bedrooms: 3,
      bathrooms: 2,
      squareFeet: 1200,
  ...
  },
  {
    ...
    price: 45000000,
    images: ['/assets/Residential/dillon-kydd-XGvwt544g8k-unsplash.jpg', '/assets/Residential/etienne-beauregard-riverin-B0aCvAVSX8E-unsplash.jpg'],
    imageUrls: ['/assets/Residential/dillon-kydd-XGvwt544g8k-unsplash.jpg', '/assets/Residential/etienne-beauregard-riverin-B0aCvAVSX8E-unsplash.jpg'],
    features: {
      bedrooms: 5,
      bathrooms: 4,
      squareFeet: 3500,
  ...
  },
  {
    ...
    imageUrls: ['/assets/Land/bogdan-pasca-XpyDh3PY2lA-unsplash.jpg'],
    features: {
      size: '2.5 acres',
      area: 2.5,
      waterAccess: true,
    ...
    landFeatures: {
      ...
      nearbyAmenities: ['Beach access', 'Main road', 'Tourist facilities'],
    },
    verification: {
      ...
      surveyorName: 'Coastal Surveyors Ltd',
      registrationNumber: 'LR/KILIFI/2023/001',
    },
    status: 'verified',
    type: 'land',
    category: 'land',
    ...
    owner: {
      id: 3,
      name: 'Coast Properties Ltd',
      email: 'info@coastproperties.co.ke',
      phone: '+254700000003',
      verified: true,
      trustScore: 78,
    },
  ...
  },
  {
    ...
    imageUrls: ['/assets/Commercial/ash-lab-ka4HDVIti78-unsplash.jpg'],
    features: {
      size: 2500,
      area: 2500,
      yearBuilt: 2019,
    ...
    owner: {
      id: 4,
      name: 'CBD Investments',
      email: 'info@cbdinvestments.co.ke',
      phone: '+254700000004',
      verified: true,
      trustScore: 88,
    },
