...
export interface UserJourney {
  ...
  name: string;
  description: string;
  userType: 'buyer' | 'seller' | 'agent' | 'developer' | 'investor';
  entryPoints: string[];
  conversionGoals: string[];
  keyPages: JourneyStep[];
  ctaSequence: string[];
}
...
export const PAGE_CONVERSION_CONFIG: Record<string, {
  primaryCTA: string;
  secondaryCTA: string;
