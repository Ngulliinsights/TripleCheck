...
export interface EnterpriseImage extends BaseImage {
  ...
  metadata?: {
    ...
    colorSpace?: string;
    dpi?: number;
    exif?: Record<string, unknown>; // Exchangeable Image File Format metadata from image files
  };
  comments?: Array<{
    id: string;
    user: string;
...
// Helper component for simple mode rendering
...
// Helper component for enterprise mode rendering
...
const ImageGallery: FC<Props> = (props) => {
  ...
  // Memoized callback for simple mode
