...
export function B2BFraudReportBanner({ className, fraudStats }: B2BFraudReportBannerProps) {
  ...
  return (
    <div className={cn(
      'bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white py-8 relative overflow-hidden',
      className
    )}>
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between">
          ...
          <div className="flex space-x-3">
            ...
            <Button
              variant="outline"
              onClick={() => window.location.href = '/contact-sales?focus=fraud-detection'}
