...
export default function Cookies() {
  ...
  const cookieTypes = [
    ...
    },
    {
      ...
      icon: Settings,
      required: false,
      description: 'These cookies enable us to provide enhanced functionality and personalization.',
      examples: [
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn about how we use cookies and similar technologies to improve your experience on TripleCheck.
          </p>
          ...
          <Card>
            ...
            <CardContent className="prose prose-gray max-w-none">
              ...
              <p>
                ...
                enhance functionality and gather insights about our platform's performance.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  We use cookies to keep you logged in securely and protect against unauthorized access. 
                  These cookies help us verify your identity and maintain your session across page visits.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Analytics cookies help us understand how users interact with our platform, which pages 
                  are most popular, and where improvements can be made. This data is aggregated and anonymous.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  We use cookies to remember your preferences, such as language settings, dashboard 
                  configurations, and search filters, to provide a more personalized experience.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Cookies help us detect and prevent fraudulent activities by tracking suspicious patterns 
                  and maintaining security measures across our verification platform.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-gray-600 mt-4">
                ...
                reviewing their policies for more information about their data handling practices.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  You can opt out of certain analytics and advertising cookies using industry opt-out tools:
                </p>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  On mobile devices, you can manage cookies and similar technologies through your 
                  device settings or by adjusting preferences within our mobile application.
                </p>
              </div>
            </CardContent>
          </Card>
