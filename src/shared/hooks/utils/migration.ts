...
export const migrationMappings: MigrationMapping[] = [
  {
    ...
    changes: {
      imports: {
        ...
        to: "import { useFormValidation } from '../hooks/useFormValidation'"
      },
      apiChanges: [
        {
  ...
  },
  {
    ...
    changes: {
      imports: {
        from: "import { useAccessibility } from '../hooks/useAccessibility'",
        to: "import { useAccessibility } from '../hooks/useAccessibility'"
      },
      apiChanges: [
        {
  ...
  },
  {
    ...
    changes: {
      imports: {
        from: "import { usePerformanceMonitor } from '../hooks/usePerformanceMonitor'",
        to: "import { useComponentPerformance } from '../hooks/useComponentPerformance'"
      },
      apiChanges: [
        {
  ...
  },
  {
    ...
    changes: {
      imports: {
        from: "import { usePropertyListVirtualization } from '../hooks/useVirtualizationHelpers'",
        to: "import { useVirtualization } from '../hooks/useMemoryOptimization'"
      },
      apiChanges: [
        {
  ...
  },
  {
    ...
    changes: {
      imports: {
        from: "import { usePaginatedQuery } from '../hooks/usePaginatedQuery'",
        to: "import { usePagination } from '../hooks/usePagination'"
      },
      apiChanges: [
        {
  ...
  },
  {
    ...
    changes: {
      imports: {
        from: "import { useInfiniteScroll } from '../hooks/useInfiniteScroll'",
        to: "import { usePagination } from '../hooks/usePagination'"
      },
      apiChanges: [
        {
 ...
 */
export function getMigrationMapping(hookName: string): MigrationMapping | undefined {
  return migrationMappings.find(mapping => mapping.oldHook === hookName);
}

/**
 * Generate migration report for a project
 */
 ...
 */
export function analyzeProject(projectPath: string): MigrationReport {
  ...
  userRegistration: {
    ...
    confirmPassword: {
      ...
      rules: {
        ...
        custom: (confirmPassword: string, formData: Record<string, any>) => {
    ...
    agreeToTerms: {
      initialValue: false,
      rules: {
        custom: (agreed: boolean) => agreed || 'You must agree to the terms and conditions',
      },
    },
  }
};
 ...
 */
export function getFormConfigPreset(presetName: keyof typeof formConfigPresets) {
  return formConfigPresets[presetName];
}