...
exports.default = FraudProtectionInfo;
var lucide_react_1 = require("lucide-react");
var react_1 = require("react");
var react_router_dom_1 = require("react-router-dom");
function FraudProtectionInfo() {
    var navigate = (0, react_router_dom_1.useNavigate)();
    // Trust metrics for the ecosystem (public stats)
    var trustMetrics = (0, react_1.useMemo)(function () { return [
        {
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="flex items-center gap-2 bg-trust-verified/10 px-4 py-2 rounded-full">
                <lucide_react_1.Activity className="w-5 h-5 text-trust-verified"/>
              ...
              <div className="flex items-center gap-2 bg-secondary/10 px-4 py-2 rounded-full">
                <lucide_react_1.Zap className="w-5 h-5 text-secondary"/>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button type="button" onClick={function () { return navigate("/auth/login"); }} className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-colors">
                Sign In to View Your Reports
              </button>
              <button type="button" onClick={function () { return navigate("/auth/register"); }} className="px-8 py-3 bg-background border border-primary text-primary rounded-lg font-semibold hover:bg-primary/5 transition-colors">
                Get Started Free
              </button>
            </div>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {trustMetrics.map(function (metric) { return (<div key={metric.label} className="bg-card border border-card-border rounded-lg p-6 text-center">
        ...
        <section className="py-12 bg-muted/30 rounded-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 px-6">
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-primary/10 rounded-full">
                  <lucide_react_1.Eye className="w-8 h-8 text-primary"/>
                </div>
              </div>
            ...
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-secondary/10 rounded-full">
                  <lucide_react_1.Brain className="w-8 h-8 text-secondary"/>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-3">
                AI Analysis
            ...
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-accent/10 rounded-full">
                  <lucide_react_1.Award className="w-8 h-8 text-accent"/>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-3">
                Simple Reports
        ...
        <section className="mt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.Shield className="w-8 h-8 text-primary mb-4"/>
            ...
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.Activity className="w-8 h-8 text-secondary mb-4"/>
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Market Analysis
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.Eye className="w-8 h-8 text-accent mb-4"/>
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Identity Checks
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.Building className="w-8 h-8 text-primary mb-4"/>
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Property History
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.CheckCircle className="w-8 h-8 text-trust-verified mb-4"/>
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Legal Compliance
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card border border-card-border rounded-lg p-6">
              <lucide_react_1.Clock className="w-8 h-8 text-secondary mb-4"/>
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Real-time Updates
              </h3>
              <p className="text-muted-foreground">
        ...
        <section className="mt-16 text-center bg-primary/5 rounded-2xl py-12 px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button type="button" onClick={function () { return navigate("/auth/register"); }} className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-colors">
              Start Free Trial
            </button>
            <button type="button" onClick={function () { return navigate("/contact"); }} className="px-8 py-3 bg-background border border-primary text-primary rounded-lg font-semibold hover:bg-primary/5 transition-colors">
              Contact Sales
            </button>
          </div>
        </section>
