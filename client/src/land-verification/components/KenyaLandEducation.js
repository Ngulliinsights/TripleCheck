...
exports.KenyaLandEducation = void 0;
...
var EDUCATION_SECTIONS = [
    {
        ...
        icon: <lucide_react_1.Home className="h-6 w-6"/>,
    ...
    },
    {
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-4 border border-red-300">
              <h4 className="font-semibold text-red-900 mb-2 flex items-center">
                <lucide_react_1.Gavel className="h-5 w-5 mr-2"/>
                Succession Disputes
              </h4>
            ...
            <div className="bg-white rounded-lg p-4 border border-red-300">
              <h4 className="font-semibold text-red-900 mb-2 flex items-center">
                <lucide_react_1.MapPin className="h-5 w-5 mr-2"/>
...
var KenyaLandEducation = function (_a) {
    var _b = _a.focusArea, focusArea = _b === void 0 ? 'overview' : _b;
    var _c = (0, react_1.useState)(focusArea), activeSection = _c[0], setActiveSection = _c[1];
    var _d = (0, react_1.useState)(''), searchTerm = _d[0], setSearchTerm = _d[1];
    var filteredSections = EDUCATION_SECTIONS.filter(function (section) {
        return searchTerm === '' ||
            section.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
            section.id === searchTerm.toLowerCase();
    });
    var currentSection = filteredSections.find(function (section) { return section.id === activeSection; }) ||
        EDUCATION_SECTIONS.find(function (section) { return section.id === activeSection; });
    return (<div className="max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        <input type="text" placeholder="Search education topics..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
      </div>
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm border p-4 sticky top-4">
            ...
            <nav className="space-y-2">
              {filteredSections.map(function (section) { return (<button key={section.id} onClick={function () { return setActiveSection(section.id); }} className={"w-full text-left p-3 rounded-lg transition-colors ".concat(activeSection === section.id
                ? 'bg-blue-100 text-blue-900 border border-blue-200'
                : 'hover:bg-gray-50 text-gray-700')}>
                  <div className="flex items-center space-x-3">
                    <div className={"".concat(activeSection === section.id ? 'text-blue-600' : 'text-gray-400')}>
                      {section.icon}
                    </div>
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg shadow-sm border p-6">
            {currentSection && filteredSections.length > 0 ? (<div>
                ...
                <lucide_react_1.Book className="h-12 w-12 text-gray-400 mx-auto mb-4"/>
...
exports.KenyaLandEducation = KenyaLandEducation;
exports.default = exports.KenyaLandEducation;
