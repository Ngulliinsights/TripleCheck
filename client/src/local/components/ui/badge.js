...
var badgeVariants = (0, class_variance_authority_1.cva)("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
    variants: {
        variant: {
            ...
            coral: "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm",
            "coral-outline": "border-secondary text-secondary hover:bg-secondary/10",
            "coral-soft": "border-transparent bg-secondary/10 text-secondary hover:bg-secondary/20",
        },
    },
    defaultVariants: {
        variant: "default",
