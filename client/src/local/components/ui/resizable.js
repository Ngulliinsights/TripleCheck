...
var ResizablePanelGroup = function (_a) {
    ...
    return (<ResizablePrimitive.Group className={(0, utils_1.cn)("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className)} {...props}/>);
};
