...
// Memoized viewport component to prevent unnecessary re-renders
var NavigationMenuViewport = React.memo(React.forwardRef(function (_a, ref) {
...
// Direct reference to the Radix primitive for better tree shaking
var NavigationMenuItem = NavigationMenuPrimitive.Item;
exports.NavigationMenuItem = NavigationMenuItem;
// Optimized trigger style with better specificity and consolidated classes
...
// Memoized chevron icon to prevent recreation on every render
var ChevronIcon = React.memo(function () { return (<lucide_react_1.ChevronDown className="relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true"/>); });
