...
var itemBase = "relative flex cursor-default select-none items-center rounded-sm py-1.5 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50";
...
var ContextMenuSubContent = React.forwardRef(function (_a, ref) {
    ...
    return (<ContextMenuPrimitive.SubContent ref={ref} className={(0, utils_1.cn)("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md", animateIn, className)} {...props}/>);
});
...
var ContextMenuContent = React.forwardRef(function (_a, ref) {
    ...
    <ContextMenuPrimitive.Content ref={ref} className={(0, utils_1.cn)("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md", animateIn, className)} {...props}/>
...
var ContextMenuItem = React.forwardRef(function (_a, ref) {
    ...
    return (<ContextMenuPrimitive.Item ref={ref} className={(0, utils_1.cn)(itemBase, "px-2", inset && "pl-8", className)} {...props}/>);
});
...
var ContextMenuCheckboxItem = React.forwardRef(function (_a, ref) {
    ...
    return (<ContextMenuPrimitive.CheckboxItem ref={ref} className={(0, utils_1.cn)(itemBase, "pl-8 pr-2", className)} checked={checked} {...props}>
...
var ContextMenuRadioItem = React.forwardRef(function (_a, ref) {
    ...
    return (<ContextMenuPrimitive.RadioItem ref={ref} className={(0, utils_1.cn)(itemBase, "pl-8 pr-2", className)} {...props}>
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <ContextMenuPrimitive.ItemIndicator>
