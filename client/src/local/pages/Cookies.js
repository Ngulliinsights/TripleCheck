      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <lucide_react_1.Cookie className="h-12 w-12 text-primary mr-3"/>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>What Are Cookies?</card_1.CardTitle>
            </card_1.CardHeader>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle className="flex items-center justify-between">
                ...
                <button_1.Button onClick={function () { return window.location.reload(); }} variant="outline" size="sm">
                  Save Preferences
                </button_1.Button>
              </card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent>
              ...
              <div className="space-y-6">
                {cookieTypes.map(function (type) {
            var Icon = type.icon;
            var isEnabled = preferences[type.id];
            return (<div key={type.id} className="border rounded-lg p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            {type.required && (<badge_1.Badge variant="secondary" className="mt-1">
                                Required
                              </badge_1.Badge>)}
                          </div>
                        </div>
                    ...
                    return togglePreference(type.id);
                }} disabled={type.required} className={"p-1 ".concat(type.required ? "cursor-not-allowed opacity-50" : "cursor-pointer")}>
                          {isEnabled ?
                    <lucide_react_1.ToggleRight className="h-8 w-8 text-primary"/>
                    : <lucide_react_1.ToggleLeft className="h-8 w-8 text-gray-400"/>}
                        </button>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <ul className="text-sm text-gray-600 space-y-1">
                            {type.examples.map(function (example, index) { return (<li key={index}>• {example}</li>); })}
                          </ul>
                        </div>
                        <div>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>How We Use Cookies</card_1.CardTitle>
            </card_1.CardHeader>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Third-Party Cookies</card_1.CardTitle>
            </card_1.CardHeader>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Managing Your Cookies</card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              <div>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Updates to This Policy</card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent>
              <p className="text-gray-700">
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Questions About Cookies</card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent>
