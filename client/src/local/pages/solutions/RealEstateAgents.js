...
exports.default = RealEstateAgents;
...
function RealEstateAgents() {
    ...
    var agentChallenges = [
        {
            icon: <lucide_react_1.Clock className="w-6 h-6 text-red-500"/>,
        ...
        {
            icon: <lucide_react_1.Users className="w-6 h-6 text-orange-500"/>,
        ...
        {
            icon: <lucide_react_1.Target className="w-6 h-6 text-yellow-500"/>,
        ...
        {
            icon: <lucide_react_1.Briefcase className="w-6 h-6 text-blue-500"/>,
    ...
    return (<div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full border border-blue-200 mb-6">
              <lucide_react_1.Briefcase className="w-4 h-4 text-blue-600"/>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button_1.Button size="lg" onClick={function () { return navigate("/mvp-demo"); }} className="bg-blue-600 hover:bg-blue-700">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {agentChallenges.map(function (challenge, index) { return (<card_1.Card key={index} className="border-l-4 border-l-blue-500">
                <card_1.CardHeader>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {agentSolutions.map(function (solution, index) { return (<card_1.Card key={index} className="relative overflow-hidden">
                <card_1.CardHeader>
                  ...
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 rounded-full border border-blue-200 mt-3">
                    <lucide_react_1.CheckCircle className="w-4 h-4 text-blue-600"/>
                ...
                <card_1.CardContent>
                  <ul className="space-y-2">
                    {solution.features.map(function (feature, featureIndex) { return (<li key={featureIndex} className="flex items-center gap-2 text-sm">
                        <lucide_react_1.CheckCircle className="w-4 h-4 text-blue-500"/>
                        <span>{feature}</span>
                      </li>); })}
                  </ul>
                </card_1.CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {agentBenefits.map(function (benefit, index) { return (<div key={index} className="text-center">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {agentFeatures.map(function (feature, index) { return (<card_1.Card key={index} className="text-center">
                ...
                <card_1.CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                      <lucide_react_1.Award className="w-6 h-6 text-blue-600"/>
                    </div>
                    <div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map(function (plan, index) { return (<card_1.Card key={index} className={"relative ".concat(plan.popular ? 'border-blue-500 shadow-lg' : '')}>
                ...
                <card_1.CardHeader className="text-center">
                  <card_1.CardTitle className="text-2xl">{plan.name}</card_1.CardTitle>
                  <div className="text-3xl font-bold text-blue-600 mt-2">{plan.price}</div>
                  <p className="text-muted-foreground">{plan.description}</p>
                </card_1.CardHeader>
                <card_1.CardContent>
                  <ul className="space-y-3">
                    {plan.features.map(function (feature, featureIndex) { return (<li key={featureIndex} className="flex items-center gap-2 text-sm">
                        <lucide_react_1.CheckCircle className="w-4 h-4 text-green-500"/>
                        <span>{feature}</span>
                      </li>); })}
                  </ul>
                  <button_1.Button className={"w-full mt-6 ".concat(plan.popular ? 'bg-blue-600 hover:bg-blue-700' : '')} variant={plan.popular ? 'default' : 'outline'} onClick={function () { return navigate("/contact"); }}>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button_1.Button size="lg" onClick={function () { return navigate("/mvp-demo"); }} className="bg-white text-blue-600 hover:bg-gray-100">
                <lucide_react_1.Shield className="w-5 h-5 mr-2"/>
                Try Agent Dashboard
              </button_1.Button>
