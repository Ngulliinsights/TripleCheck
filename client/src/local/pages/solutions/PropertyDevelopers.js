...
var PropertyDevelopers = function () {
    return (<div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <lucide_react_1.Building2 className="h-8 w-8 text-blue-300 mr-3"/>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <react_router_dom_1.Link to="/auth/register" className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center">
                  Start Enterprise Trial
                  <lucide_react_1.ArrowRight className="ml-2 h-5 w-5"/>
                </react_router_dom_1.Link>
                <react_router_dom_1.Link to="/contact" className="border-2 border-blue-300 text-blue-300 hover:bg-blue-300 hover:text-blue-900 px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center">
                  Schedule Demo
                </react_router_dom_1.Link>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100">
              <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mb-6">
                <lucide_react_1.Shield className="h-6 w-6 text-red-600"/>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <lucide_react_1.CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-1 flex-shrink-0"/>
                  <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <lucide_react_1.Users className="h-6 w-6 text-blue-500 mr-3 mt-1 flex-shrink-0"/>
                  <div>
                ...
                <div className="flex items-start">
                  <lucide_react_1.MapPin className="h-6 w-6 text-blue-500 mr-3 mt-1 flex-shrink-0"/>
                  <div>
                ...
                <div className="flex items-start">
                  <lucide_react_1.Award className="h-6 w-6 text-blue-500 mr-3 mt-1 flex-shrink-0"/>
                  <div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                  <lucide_react_1.Building2 className="h-6 w-6 text-blue-600"/>
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mr-4">
                  <lucide_react_1.TrendingUp className="h-6 w-6 text-green-600"/>
                </div>
                <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <react_router_dom_1.Link to="/pricing" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
              View Full Pricing
            </react_router_dom_1.Link>
            <react_router_dom_1.Link to="/contact" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-lg font-semibold transition-colors">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <react_router_dom_1.Link to="/auth/register" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center">
              Start Enterprise Trial
              <lucide_react_1.ArrowRight className="ml-2 h-5 w-5"/>
            </react_router_dom_1.Link>
            <react_router_dom_1.Link to="/contact" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-lg font-semibold transition-colors">
              Schedule Demo
            </react_router_dom_1.Link>
          </div>
        </div>
...
exports.default = PropertyDevelopers;
