...
// Constants
var RESPONSE_TIME_WEEKS = "weeks";
var CARD_BORDER_STYLES = "border border-slate-200 rounded p-4";
var TITLE_DEED_FRAUD_BEST_FOR = "Title deed fraud, illegal subdivisions, boundary disputes";
var STEP_NUMBER_BLUE_CLASSES = "bg-blue-100 text-blue-800 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold";
var STEP_NUMBER_RED_CLASSES = "bg-red-100 text-red-800 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold";
var ARDHISASA_WEBSITE = "ardhisasa.lands.go.ke";
var AccordionSection = function (_a) {
    ...
    var getPriorityStyles = function (priorityLevel) {
    ...
    var styles = getPriorityStyles(priority);
    return (<card_1.Card className={"".concat(styles.bg, " ").concat(styles.border, " shadow-lg hover:shadow-xl transition-all duration-300")}>
      <div className="m-0">
        <button type="button" onClick={onToggle} className={"w-full flex justify-between items-center p-6 text-left font-semibold text-slate-800 transition-all duration-300 ".concat(styles.bg, " ").concat(styles.hover, " rounded-lg")} aria-expanded={isOpen ? "true" : "false"}>
          <span className="flex items-center gap-3 text-lg">
            {icon}
            {title}
          </span>
          <div className={"w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ".concat(isOpen ? "bg-white/50 rotate-180" : "bg-white/30")}>
            <span className="text-lg font-mono">{isOpen ? "−" : "+"}</span>
          </div>
        </button>
      </div>
      {isOpen && (<card_1.CardContent className="pt-0 pb-6 px-6">
...
var ReportingChannelsSection = function () {
    var channels = [
        {
            ...
            agencies: [
                {
                    ...
                    website: "dci.go.ke",
                    process: "Report to Public Complaints Office first, get referral form to Land Fraud Unit",
                    responseTime: "2-4 ".concat(RESPONSE_TIME_WEEKS),
                ...
                },
                {
                    ...
                    responseTime: "3-6 ".concat(RESPONSE_TIME_WEEKS),
            ...
            agencies: [
                {
                    ...
                    responseTime: "4-8 ".concat(RESPONSE_TIME_WEEKS),
                ...
                },
                {
                    ...
                    responseTime: "6-12 ".concat(RESPONSE_TIME_WEEKS),
    ...
    var StarRating = function (_a) {
      ...
      {[1, 2, 3, 4, 5].map(function (star) { return (<lucide_react_1.Star key={star} className={"h-4 w-4 ".concat(star <= rating ? "text-yellow-500 fill-current" : "text-gray-300")}/>); })}
    </div>);
    };
    return (<div className="space-y-6">
      ...
      {channels.map(function (tier, tierIndex) { return (<div key={tierIndex} className="space-y-4">
          <h4 className={"font-bold px-3 py-1 rounded ".concat(tier.tierColor)}>
            {tier.tier}
          </h4>

          <div className="grid gap-4">
            {tier.agencies.map(function (agency, agencyIndex) { return (<div key={agencyIndex} className={"".concat(CARD_BORDER_STYLES, " space-y-3")}>
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-sm">
                  ...
                  {agency.responseTime && (<div className="flex items-center gap-2">
                      <lucide_react_1.Clock className="h-4 w-4 text-slate-500"/>
                ...
                {agency.limitation && (<div className="text-sm text-orange-700 bg-orange-50 p-2 rounded">
...
var PreventionSection = function () {
    var commonFrauds = [
        {
            type: "Title Deed Fraud",
            description: "Forged or duplicate title deeds, selling the same property multiple times",
            redFlags: [
        ...
        },
        {
            ...
            description: "Selling non-existent developments or misappropriating project funds",
            redFlags: [
        ...
        },
        {
            ...
            description: "Specifically targeting overseas Kenyans through remote viewing scams",
            redFlags: [
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {commonFrauds.map(function (fraud, index) { return (<div key={index} className={CARD_BORDER_STYLES}>
      ...
      <div className="space-y-4">
        ...
        {preventionChecklist.map(function (category, index) { return (<div key={index} className="space-y-2">
            <h5 className="font-medium text-slate-800">{category.category}</h5>
            <div className="space-y-2 ml-4">
              {category.items.map(function (item, itemIndex) { return (<div key={itemIndex} className="flex items-start gap-2">
...
// Directory Component
var DirectorySection = function () {
    var agencies = [
        {
            name: "DCI – Land Fraud Unit",
            role: "Investigates complex land scams & fake titles",
            address: "Mazingira Complex, Kiambu Road (opposite Kenya Forest Service HQ)",
    ...
    return (<div className="space-y-4">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full table-auto text-sm border-collapse border border-slate-300">
          ...
          <tbody>
            {agencies.map(function (agency, index) { return (<tr key={index} className="border-b border-slate-200 hover:bg-slate-50">
                ...
                <td className="p-3 border border-slate-300 space-y-1">
                  {agency.address && (<div className="text-xs text-slate-600">
                      {agency.address}
                    </div>)}
                  ...
                  {agency.email && (<div className="flex items-center gap-1">
                      <lucide_react_1.Mail className="h-3 w-3"/>
                      <a href={"mailto:".concat(agency.email)} className="text-blue-600 hover:underline">
                        {agency.email}
                      </a>
                    </div>)}
                  {agency.note && (<div className="text-xs text-slate-500 italic">
                      {agency.note}
                    </div>)}
                </td>
              </tr>); })}
...
var LegalRedressSection = function () {
    var redressOptions = [
        {
            rank: 1,
            title: "Criminal Investigation (DCI Land Fraud Unit)",
            description: "Initiates criminal investigation, can freeze assets, and gather evidence for prosecution",
        ...
        },
        {
            ...
            description: "File for compensation and restoration of ownership in Environment & Land Court",
        ...
        },
        {
            ...
            description: "Mediation or arbitration for quicker, cheaper settlement when parties agree",
            timeline: "1-6 months",
            cost: "Medium",
            successFactors: [
                "Willing parties",
        ...
        },
        {
            ...
            description: "Independent experts verify forged titles or signatures to strengthen other cases",
            timeline: "1-3 months",
            cost: "Medium-High",
            successFactors: [
                "Suspected forgery",
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        {redressOptions.map(function (option) { return (<div key={option.rank} className="border border-slate-200 rounded-lg p-5">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <div className="space-y-1">
                  {option.pros.map(function (pro, index) { return (<div key={index} className="flex items-center gap-1">
              ...
              <div>
                ...
                <div className="space-y-1">
                  {option.cons.map(function (con, index) { return (<div key={index} className="flex items-center gap-1">
              ...
              <div>
                ...
                <div className="space-y-1">
                  {option.successFactors.map(function (factor, index) { return (<div key={index} className="flex items-center gap-1">
                      <lucide_react_1.Star className="h-3 w-3 text-blue-500"/>
                      <span>{factor}</span>
                    </div>); })}
                </div>
              </div>
      ...
      <div className="bg-green-50 border border-green-200 p-4 rounded">
        ...
        ].map(function (factor, index) { return (<div key={index} className="flex items-center gap-2">
...
var DigitalToolsSection = function () {
    var digitalTools = [
        {
    ...
    return (<div className="space-y-6">
      ...
      {digitalTools.map(function (category, index) { return (<div key={index} className="space-y-3">
          <h4 className="font-semibold text-lg">{category.category}</h4>
          <div className="grid gap-3">
            {category.tools.map(function (tool, toolIndex) { return (<div key={toolIndex} className="border border-slate-200 rounded p-3 flex justify-between items-start">
                ...
                <div className="ml-4">
                  {tool.url.includes(".") ?
                    <a href={"https://".concat(tool.url)} className="text-blue-600 hover:underline text-sm flex items-center gap-1">
...
// Main Component
var KenyaRealEstateFraudGuide = function () {
    var _a = (0, react_1.useState)("emergency"), openSection = _a[0], setOpenSection = _a[1];
    var toggle = function (key) {
        return setOpenSection(openSection === key ? null : key);
    };
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-red-50/20 to-slate-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-8">
            <card_1.Card className="bg-gradient-to-br from-green-100 to-green-200 border-green-300 shadow-lg">
            ...
            <card_1.Card className="bg-gradient-to-br from-yellow-100 to-yellow-200 border-yellow-300 shadow-lg">
              <card_1.CardContent className="p-4 text-center">
            ...
            <card_1.Card className="bg-gradient-to-br from-red-100 to-red-200 border-red-300 shadow-lg">
              <card_1.CardContent className="p-4 text-center">
          ...
          <card_1.Card className="bg-gradient-to-br from-red-100 to-orange-100 border-red-300 shadow-xl max-w-2xl mx-auto">
            <card_1.CardContent className="p-6">
              <div className="flex items-center gap-3 justify-center mb-3">
                <div className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center animate-pulse">
                  <lucide_react_1.AlertTriangle className="h-5 w-5 text-white"/>
                </div>
        ...
        <card_1.Card className="bg-gradient-to-r from-red-600 to-red-700 text-white border-0 shadow-2xl mb-8">
          <card_1.CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center animate-pulse">
                <lucide_react_1.Phone className="h-6 w-6 text-white"/>
              </div>
              <div>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <a href="tel:0800722203" className="flex items-center gap-3 bg-white/10 rounded-lg p-4 hover:bg-white/20 transition-colors">
                <lucide_react_1.Phone className="h-5 w-5 text-red-200"/>
                <div>
              ...
              <a href="https://dci.go.ke" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/10 rounded-lg p-4 hover:bg-white/20 transition-colors">
                <lucide_react_1.Globe className="h-5 w-5 text-red-200"/>
                <div>
        ...
        {/* Accordion Sections */}
        <div className="space-y-4">
          <AccordionSection title="🚨 Emergency Action Plan (First 48 Hours)" isOpen={openSection === "emergency"} onToggle={function () { return toggle("emergency"); }} icon={<lucide_react_1.AlertTriangle className="h-5 w-5"/>} priority="high">
            <EmergencySection />
          </AccordionSection>

          <AccordionSection title="📊 Reporting Channels (Ranked by Effectiveness)" isOpen={openSection === "channels"} onToggle={function () { return toggle("channels"); }} icon={<lucide_react_1.Star className="h-5 w-5"/>} priority="high">
            <ReportingChannelsSection />
          </AccordionSection>

          <AccordionSection title="🛡️ Prevention & Red Flag Recognition" isOpen={openSection === "prevention"} onToggle={function () { return toggle("prevention"); }} icon={<lucide_react_1.Shield className="h-5 w-5"/>} priority="medium">
            <PreventionSection />
          </AccordionSection>

          <AccordionSection title="📞 Complete Agency Directory" isOpen={openSection === "directory"} onToggle={function () { return toggle("directory"); }} icon={<lucide_react_1.Phone className="h-5 w-5"/>} priority="medium">
            <DirectorySection />
          </AccordionSection>

          <AccordionSection title="⚖️ Legal Redress Options (Ranked)" isOpen={openSection === "legal"} onToggle={function () { return toggle("legal"); }} icon={<lucide_react_1.CheckCircle className="h-5 w-5"/>} priority="medium">
            <LegalRedressSection />
          </AccordionSection>

          <AccordionSection title="💻 Digital Reporting Tools & Documentation" isOpen={openSection === "digital"} onToggle={function () { return toggle("digital"); }} icon={<lucide_react_1.Globe className="h-5 w-5"/>} priority="low">
            <DigitalToolsSection />
          </AccordionSection>
        </div>

        {/* Enhanced Footer */}
        <card_1.Card className="mt-12 bg-gradient-to-br from-slate-100 to-slate-200/50 border-slate-300 shadow-lg">
...
exports.default = KenyaRealEstateFraudGuide;
