...
function GettingStarted() {
    ...
    var handleStepClick = function (step, url) {
        trackNavigation('/help/getting-started', url, "getting_started_".concat(step));
    ...
    var steps = [
        {
            ...
            duration: '2 minutes',
            action: function () { return handleStepClick('signup', '/register'); },
        ...
        },
        {
            ...
            duration: '1 minute',
            action: function () { return handleStepClick('verification_types', '/services'); },
        ...
        },
        {
            ...
            duration: '5 minutes',
            action: function () { return handleStepClick('upload', '/services/basic-checks'); },
        ...
        },
        {
            ...
            action: function () { return handleStepClick('reports', '/trust/reports'); },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="inline-flex items-center justify-center w-28 h-28 glass-base bg-white/10 rounded-3xl mb-10 hover-glow-premium animate-fade-in">
              <lucide_react_1.BookOpen className="h-14 w-14 text-white drop-shadow-lg"/>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-slide-up animation-delay-200">
              <button_1.Button size="lg" variant="secondary" className="glass-btn-primary px-10 py-5 text-lg font-semibold hover-glow-warm" onClick={function () { return handleStepClick('start_now', '/register'); }}>
                <lucide_react_1.Play className="mr-3 h-6 w-6"/>
                Start Now
              </button_1.Button>
              <button_1.Button size="lg" variant="outline" className="btn-glass border-white/30 text-white hover:bg-white/10 px-10 py-5 text-lg font-semibold" onClick={function () { return handleStepClick('watch_demo', '/demo'); }}>
                Watch Demo
                <lucide_react_1.ArrowRight className="ml-3 h-6 w-6"/>
              </button_1.Button>
            </div>
      ...
      <section className="py-24 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            return (<div key={index} className="relative animate-slide-up" style={{ animationDelay: "".concat(200 + index * 150, "ms") }}>
                      ...
                      <div className="glass-base bg-white/80 rounded-3xl p-10 layer-depth-2 enhance-hover">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
                          ...
                          <div className="glass-base bg-accent/10 rounded-2xl px-6 py-3 inline-flex items-center">
                            <lucide_react_1.Clock className="h-5 w-5 mr-3 text-accent"/>
                        ...
                        <button_1.Button onClick={step.action} className="glass-btn-primary w-full lg:w-auto px-10 py-4 text-lg font-semibold hover-glow-warm" size="lg">
                          {step.actionText}
                  ...
                  {!isLast && (<div className="absolute left-16 top-32 w-1 h-20 bg-gradient-to-b from-primary via-secondary to-accent rounded-full hidden lg:block opacity-30"/>)}
                </div>);
        })}
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
            {quickTips.map(function (tip, index) {
            var IconComponent = tip.icon;
            var colors = ['primary', 'secondary', 'accent', 'primary'];
            var color = colors[index % colors.length];
            return (<div key={index} className="glass-base bg-white/60 rounded-3xl p-10 layer-depth-1 enhance-hover animate-slide-up" style={{ animationDelay: "".concat(index * 150, "ms") }}>
                  <div className="flex items-start">
                    <div className={"p-6 bg-gradient-to-br from-".concat(color, "/10 to-").concat(color, "/5 rounded-3xl mr-8 flex-shrink-0 hover-glow-").concat(color === 'primary' ? 'trust' : color === 'secondary' ? 'warm' : 'premium')}>
                      <IconComponent className={"h-10 w-10 text-".concat(color)}/>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map(function (faq, index) { return (<div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 glass-base bg-white/10 rounded-2xl mb-8">
              <lucide_react_1.Star className="h-10 w-10 text-white"/>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button_1.Button size="lg" variant="secondary" className="glass-btn-primary px-12 py-5 text-xl font-semibold hover-glow-warm" onClick={function () { return handleStepClick('cta_signup', '/register'); }}>
                <lucide_react_1.Users className="mr-3 h-6 w-6"/>
                Create Free Account
                <lucide_react_1.ArrowRight className="ml-3 h-6 w-6"/>
              </button_1.Button>
              <button_1.Button size="lg" variant="outline" className="btn-glass border-white/30 text-white hover:bg-white/10 px-12 py-5 text-xl font-semibold" onClick={function () { return handleStepClick('cta_contact', '/contact'); }}>
                Contact Support
              </button_1.Button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
            { icon: lucide_react_1.Shield, text: "Bank-Level Security" },
            { icon: lucide_react_1.CheckCircle, text: "99.8% Accuracy" },
            { icon: lucide_react_1.Users, text: "10,000+ Users" },
            { icon: lucide_react_1.Clock, text: "24/7 Support" }
        ].map(function (item, index) {
            var IconComponent = item.icon;
            return (<div key={index} className="flex flex-col items-center text-white/80 animate-fade-in" style={{ animationDelay: "".concat(index * 100, "ms") }}>
