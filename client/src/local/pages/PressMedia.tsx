...
const PressReleaseCard = memo(({ release }: { release: PressRelease }) => (
  <article className="border-l-4 border-[#2C5282] pl-6 py-2">
    <div className="flex items-start justify-between mb-2">
      <h3 className="text-lg font-semibold text-gray-800 leading-tight">
        {release.title}
      </h3>
      <Badge className="bg-[#2C5282] text-white ml-4 shrink-0">
        {release.category}
      </Badge>
    </div>
...
const MediaFeatureCard = memo(({ feature }: { feature: MediaFeature }) => (
  <article className="flex items-center justify-between p-4 border rounded-lg hover:border-[#2C5282] transition-colors">
    <div>
    ...
    >
      View <ExternalLink className="ml-2 h-4 w-4" aria-hidden="true" />
    </Button>
  </article>
));
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-12">
      <div className="max-w-6xl mx-auto px-4">
            ...
            <CardContent>
              <ul className="space-y-6 list-none">
                {pressReleases.map((release) => (
                  <li key={release.id || release.title}>
        ...
        <section className="mb-12">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-[#2C5282]">
                Media Coverage
              </CardTitle>
            </CardHeader>
            <CardContent>
