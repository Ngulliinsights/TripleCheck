...
exports.default = NavigationTest;
...
function NavigationTest() {
    var _a = (0, useNavigationSpacing_1.usePageSpacing)(), navHeight = _a.navHeight, isScrolled = _a.isScrolled, pageStyle = _a.pageStyle;
    return (<div className="min-h-screen bg-background nav-aware-spacing">
      {/* Status indicator */}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {Array.from({ length: 10 }, function (_, i) { return (<section key={i}>
