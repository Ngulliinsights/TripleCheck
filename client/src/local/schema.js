...
console.warn('⚠️ DEPRECATION WARNING: You are importing from server/infrastructure/database/schemas/consolidated. ' +
...
__exportStar(require("../../server/infrastructure/database/schemas/consolidated"), exports);
