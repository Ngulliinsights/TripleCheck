 ...
 * 
 * @deprecated This hook is deprecated in favor of useProperty
 * Please migrate to useProperty().useLandProperty for better error handling and consistency.
 * Migration guide: Replace useLandProperty(id) with useProperty().useLandProperty(id)
 */
export function useLandProperty(id: string): UseLandPropertyResult {
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    console.warn(
      "[DEPRECATED] useLandProperty is deprecated. Please migrate to useProperty().useLandProperty for better error handling and consistency."
    );
  }
  const {
    data,
