...
exports.default = PropertiesResidential;
 ...
 */
function PropertiesResidential() {
    ...
    return (<>
      <PropertyListingPage_1.PropertyListingPage config={propertyTypes_1.residentialConfig} enableCompare={true} enablePhotoManagement={true} heroConfig={{
