...
import { registerCommunityTrustRoutes } from "./community-trust-routes";
import { registerSecureDocumentRoutes } from "./secure-document-routes";
...
export function registerRoutes(app: Express): void {
  ...
  // AI routes are registered in index.ts to avoid duplication
