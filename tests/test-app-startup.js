...
function testAppStartup() {
    return __awaiter(this, void 0, void 0, function () {
        var testDatabaseConnection, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./server/test-db-connection'); })];
                case 2:
                    testDatabaseConnection = (_a.sent()).testDatabaseConnection;
                    // Database test is already working
                    // Test basic server imports
                    console.log('2. Testing server imports...');
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./server/main.minimal'); })];
                case 3:
                    _a.sent();
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./src/app/App'); })];
                case 4:
                    _a.sent();
