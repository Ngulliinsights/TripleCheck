...
exports.getTestProperty = getTestProperty;
exports.isCI = isCI;
...
function getBaseUrl() {
    ...
    return process.env.PLAYWRIGHT_BASE_URL || exports.TEST_CONFIG.BASE_URLS[env] || exports.TEST_CONFIG.BASE_URLS.development;
}
// Helper function to get test user by role
function getTestUser(role) {
    return exports.TEST_CONFIG.TEST_USERS[role];
}
// Helper function to get test property by type
function getTestProperty(type) {
    return exports.TEST_CONFIG.TEST_PROPERTIES[type];
}
// Helper function to check if running in CI
function isCI() {
    return exports.TEST_CONFIG.ENV.CI;
}
// Helper function to check if debug mode is enabled
function isDebugMode() {
    return exports.TEST_CONFIG.ENV.DEBUG;
}
// Helper function to get timeout for specific operation
function getTimeout(operation) {
    return exports.TEST_CONFIG.TIMEOUTS[operation];
}
